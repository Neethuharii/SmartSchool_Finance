...
class FeeCategoryController extends AbstractController
{
    ...
    #[Route('/invoice/new', name: 'finance_invoice_new', methods: ['GET', 'POST'])]
    public function newInvoice(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if (empty($studentId) || empty($categoryId)) {
                ...
                return $this->redirectToRoute('finance_invoice_new');
            }
        ...
        return $this->render('finance/fee_category/fee_category.html.twig', [
            'students' => $students,
    ...
    #[Route('/invoices', name: 'finance_invoice_list', methods: ['GET'])]
    public function listInvoices(EntityManagerInterface $em): Response
    {
      
        $invoices = $em->getRepository(FeeInvoice::class)->findBy([], ['createdAt' => 'DESC']);

       
        return $this->render('finance/fee_category/invoice_list.html.twig', [
            'invoices' => $invoices,
        ]);
    }
    ...
    // ==========================================
    #[Route('/bulk-invoice', name: 'finance_bulk_invoice', methods: ['GET', 'POST'])]
    public function bulkInvoice(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if (empty($sectionId) || empty($categoryId) || $totalAmount <= 0) {
                ...
                return $this->redirectToRoute('finance_bulk_invoice');
            }
            ...
            return $this->redirectToRoute('finance_invoice_list');
        }

      
        return $this->render('finance/fee_category/fee_category_new.html.twig', [
            'sections' => $sections,
            'categories' => $categories,
        ]);
    }
